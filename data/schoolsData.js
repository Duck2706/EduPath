const schoolsData = {
  "Miền Bắc": [
    ...
    "Đại học Y dược – ĐHQG Hà Nội (QHY)",
    "Đại học Y Hà Nội (YHB)",
    "Đại học Y tế Công cộng (YTC)",
    "Trường Quản trị và Kinh doanh – ĐHQG Hà Nội (QHD)",
    ...
    "Khoa Các khoa học liên ngành – ĐHQG Hà Nội (QHK)",
    ...
    "Đại học Thiết kế và Thời trang London (DTL)",
